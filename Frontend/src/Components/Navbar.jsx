...
const navItems =(
  <>
  {/* <li><a href='/'>Home</a></li>
  <li><a href='menswatch'>Men's Watch</a></li>
  <li><a href='Contact'>Contact</a></li>
  <li><a  href='/About'>About</a></li> */}
   <Link to="/"><li><a>Home</a></li></Link>
   <Link to="/Menswatch"><li><a>Mens Watch</a></li></Link>
   <Link to="/Contact"><li><a>Contact us</a></li></Link>
   <Link to="/About"><li><a>About</a></li></Link>
  </>
  )
  return (
    <div className={`mx-w-screen-2xl mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${
      sticky?"sticky-navbar shadow-md  dark:bg-slate-800 dark:text-white bg-base-200 duration-300 translate-all ease-in-out":""
    }`}>
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-1 z-[1] p-2 shadow bg-base-100 rounded-box w-52  dark:bg-slate-900 dark:text-white ">
      {navItems}
      </ul>
    </div>
   <Link to="/"><a className="text-2x1 cursor-pointer btn btn-ghost text-xl">Watch Store</a></Link>
  </div>
